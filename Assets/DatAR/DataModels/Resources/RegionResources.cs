...
{
    public sealed class RegionResource : DynamicResource
    {
        public RegionResource(List<string> types, int appearTimes, DynamicResource concept, DynamicResource region)
        {
            Types = types;
