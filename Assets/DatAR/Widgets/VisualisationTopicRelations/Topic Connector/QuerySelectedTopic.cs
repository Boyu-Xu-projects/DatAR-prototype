...
public class QuerySelectedTopic : MonoBehaviour, IQueryState
{
    private SparqlService _sparqlService;
    public BrainTopicManager BrainTopics;
    public TMPro.TextMeshPro topicText; 
    ...
    async public void GetConnectedTopics()
    {
        ...
        try
        {
            ...
            string topicLabel = topicText.GetComponent<TMP_InputField>().text;
